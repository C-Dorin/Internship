			...
			{context.isOpen && (
				<>
					<motion.div
						...
						aria-modal="true"
						className={cn(
							'absolute overflow-hidden rounded-md border bg-background p-2 text-foreground shadow-md border-muted dark:border-muted dark:bg-background dark:text-foreground',
							className
						)}
						initial="initial"
						animate="animate"
