	...
	public: {
		...
		Functions: {
			...
			insert_new_cursa: {
				Args: {
					_ziua_sapt: string;
					_ora_decolare: string;
					_ora_aterizare: string;
					_directia: string;
					_id_avion: number;
					_oras_destinatie: string;
				};
				Returns: undefined;
			};
			make_cursa_amanata_or_anulata: {
				Args: { _cod: string; _is_amanata: boolean; _is_anulata: boolean };
				Returns: undefined;
			};
			show_aterizari: {
